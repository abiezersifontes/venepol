...
<script type="text/javascript">
	$(document).ready(function()
    {
		 $(".btn").click(function(){
			 $.ajax({
				   type: "POST",
				   url: '../procesar/mod_procedimiento.php',
	...
	<div class="container">
		...
		<div id="inicio">
			...
			<table id="division2">
				<tr>
					<td>
						<h1>Registro de Procedimiento</h1>
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					<td>
						...
						if(mysqli_num_rows($resultado)){
							...
							echo "no se podido realizar la consulta con el siguiente id:".$id_procedimiento;
						}
						?>
							<h2>Datos</h2>
							<table id="division">
				...
				<tr>
					<td>
					    ...
					    <input type="hidden" value=" <?php echo $_GET['id_procedimiento']; ?>" name="id_procedimiento" id="id_procedimiento">
