							...
							<table id="division">
								...
								<tr>
									...
									<td>
										...
										Masculino <input type="radio" value="femenino" name="sexo" id="sexo"/>
									</td>
								</tr>
								<tr>
								...
								<td>Ciudad<span id="red">(*)</span></td>
								  <td>
									  <input type="text" name="ciudad_D" id="ciudad_D"/>
								  </td>
								</tr>
								<tr>
								  <td>Calle/Av<span id="red">(*)</span></td>
								  <td>
									  <input type="text" name="calle_D" id="calle_D"/>
								  </td>
								</tr>
								<tr>
									<td>N&ordm; Domicilio<span id="red">(*)</span></td>
								  <td>
									  <input type="text" name="n_domicilio_D" id="n_domicilio_D"/>
								  </td>
								</tr>
								<tr>
								...
								<tr>
								  ...
								  <td>
										<input type="text" id="delito" name="delito">
									</div>
								  </td>
								<tr>
								  <td>Relato<span id="red">(*)</span></td>
								  <td>
									  <textarea name="relato_H" placeholder="Escriba el Relato del Denunciante..." id="relato_H"></textarea>
								  </td>
								</tr>
				  </table>
							...
							<div class="formulario2">
							  <table id="division">
								...
								<tr>
								  <td>Ciudad<span id="red">(*)</span></td>
								  <td>
									  <input type="text" name="ciudad_H" id="ciudad_H"/>
								  </td>
								</tr>
								<tr>
								  <td>Calle/Av<span id="red">(*)</span></td>
								  <td>
									  <input type="text" name="calle_H" id="calle_H"/>
								  </td>
								</tr>
								<tr>
								  <td>Cuadrante<span id="red">(*)</span></td>
								  <td>
									<input type="text" name="cuadrante_H" id="cuadrante_H"/>
								  </td>
								</tr>
								<tr>
								<tr>
								...
								<tr>
								  ...
								  <td>
									<textarea name="preguntas_y_respuestas" id="preguntas_y_respuestas" placeholder="Escriba las Preguntas y Respuestas..."></textarea>
								  </td>
								</tr>
				</table>
				</div>
