...
<html lang="es">
	...
	<meta charset="UTF-8">
		...
		$(document).ready(function(){
			...
			$(document).on('click',"#eliminar_novedad",function(){
			...
			$(document).on('click',"#generar_acta",function(){
				...
				window.location="../consultas/acta_novedad.php?id_novedad="+id;
			});
			});
			

			$(document).on('click',"#modificar_novedad",function(){
			
				var id = $(this).closest('tr').find(".id").text();
				
				window.location="../formularios/form_novedad_modal.php?id_novedad="+id;
			});
		...
		<body>
			<div id="inicio">
				...
				<div id="menu">
						<table id="fecha">
                                                	<center><h1>Consultar Novedad</h1></center></br>
                                                    <tr>
									<form>	
									<td>DESDE:</td><td>
									<select id="ano1">
							...
							<td>
								...
								<select id="dia2">
									...
									<option value="31">31</option>
                                            ...
                                            <tr>
							<td id='generar_acta'>
                                                            <a href="../formularios/form_novedad.php"><img src="../recursos/agregar.jpg" id='logo'><a/>
							</td>
						</tr>
					</table>
					</br>					
