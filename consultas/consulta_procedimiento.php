...
<html lang="es">
	...
	<meta charset="UTF-8">
		...
		$(document).ready(function(){
			...
			$(document).on('click',"#eliminar_procedimiento",function(){
			...
			$(document).on('click',"#modificar_procedimiento",function(){
			
				var id = $(this).closest('tr').find(".id").text();
				
				window.location="../formularios/form_procedimiento_modal.php?id_procedimiento="+id;
			});
			...
			$(document).on('click',"#generar_acta",function(){
				...
				window.location="../consultas/acta_procedimiento.php?id_procedimiento="+id;
			});
			});
		</script>
		</head>
		...
		<div id="inicio">
				...
				<div id="menu">
						<table id="fecha">
                                                    <center><h1>Consultar Procedimientos</h1></center></br>
							<tr>
									<form>	
									<td>DESDE:</td><td>
									<select id="ano1">
							...
							<td>
								...
								<select id="dia2">
									...
									<option value="31">31</option>
                                                ...
                                                <tr>
							<td id='generar_acta'>
                                                            <a href="../formularios/form_procedimiento.php"><img src="../recursos/agregar.jpg" id='logo'><a/>
							</td>
						</tr>
					</table>
					</br>						
